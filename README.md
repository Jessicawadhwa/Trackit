...
<br />
  ...
  <h3 align="center">Issue and Project Tracking System <a href="https://trackit-demo.vercel.app/"></a></h3>
...
## 🛠️Technologies
Frontend : NextJs, Chakra UI, Axios
...
```sh
git clone https://github.com/Jessicawadhwa/Trackit.git
```
